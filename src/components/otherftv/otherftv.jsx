            ...
            <>
                <div id="promo-outer">
                    <div class="container-fluid  padding-top-2">
                        <div class="row oftv bentonsans justify-content-center padding-bottom">
                            Other Films and TV Projects
                        </div>
                        <div class="row gallery-row padding-top">
                            <div class="col gallery-col all-pad no-l-pad no-r-pad d-flex flex-column align-items-center cursor" onClick={() => this.openModal('1R1C')}>
                            ...
                            <div class="col gallery-col all-pad no-r-pad no-l-pad d-flex flex-column align-items-center cursor" onClick={() => this.openModal('1R2C')}>
                            ...
                            <div class="col gallery-col all-pad no-r-pad no-l-pad d-flex flex-column align-items-center cursor" onClick={() => this.openModal('2R2C')}>
