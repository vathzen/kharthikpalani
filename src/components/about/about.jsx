...
class About extends Component{
    render(){
        return(
            <div id="about-page">
                <div class="container">
                    <div class="row montserrat content-title font-white d-flex justify-content-center margin-bottom">ABOUT</div>
                    <div class="row montserrat content font-white">
                        <p>Kharthik Phalani is an Indian cinematographer who works in the Indian film industry. After completing his Under Graduation in Physics, He did Diploma in Film Technology (Cinematography) in FiIm & Television Institute of Tamilnadu, and started assisting Tirru from 2009.</p>
                    </div>
                    <div class="row">
                        <div class="col">
                            <img src={Still} alt="" width="100%"/>
                        </div>
                    ...
                    <div class="row montserrat content font-white pad-top">
